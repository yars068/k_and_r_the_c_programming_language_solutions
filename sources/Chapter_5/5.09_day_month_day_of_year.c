...
static char   days_in_months[] = { 0, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 };
static char days_leap_months[] = { 0, 31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 };

static char *daytab[] = { days_in_months, days_leap_months };
...
int get_month_day(int year, int yearday, int *pmonth, int *pday) {
  ...
  leap = year%4 == 0 && year%100 != 0 || year%400 == 0;
  if (yearday && yearday  <= *(maxdays + leap)) {
